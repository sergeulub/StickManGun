...
public class InventoryOld : MonoBehaviour
{
    ...
    public PlayerLoadout playerLoadout; // ScriptObj ��� 6 ��������, ������� ���������� � ���
    ...
    [Space]
    [SerializeField] public List<int> inventory = new List<int>();// � ������ ������ ���� ID ��������
    [SerializeField] public List<int> arsenal = new List<int>();//1 - ���� ������� ������, 0 - ���� ���
    ...
    {   
        ...
        if (!item.sprite.name.Contains("empty"))
        {
            ...
            itemInfo[3].GetComponent<Text>().text = "��. " + (lvls[item.id] + 1).ToString();
            if (lvls[item.id] != 9)
            {
            ...
            if (item.type == ItemType.Weapon)
            {
                ...
                itemInfo[6].transform.GetChild(2).gameObject.GetComponent<TMP_Text>().text = "����";
                if (item.id != 5)
                {
                ...
                itemInfo[7].transform.GetChild(2).gameObject.GetComponent<TMP_Text>().text = "���� � �������";
                if (item.id != 5)
                {
                ...
                itemInfo[8].transform.GetChild(1).gameObject.GetComponent<TMP_Text>().text = "�����������";
                ...
                itemInfo[9].transform.GetChild(1).gameObject.GetComponent<TMP_Text>().text = "������������";
                ...
                itemInfo[10].transform.GetChild(1).gameObject.GetComponent<TMP_Text>().text = "������";
                ...
                itemInfo[11].transform.GetChild(1).gameObject.GetComponent<TMP_Text>().text = "�������� ��������";
    ...
    private void PrepareForBattle()
    {
        for (int i = 0; i < 6; i++)
        {
            ...
            Debug.Log($"����� ���� � ����� {data.items[playerLoadout.activeItems[i]].name}");
        }
        Debug.Log($"� ���!");
