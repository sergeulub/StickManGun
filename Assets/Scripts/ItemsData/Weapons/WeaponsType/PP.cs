...
{
    public PP(Weapons data) : base(data) { }
    ...
    public override void RotateWeapon()
    {
        ...
        if (isLookingRight)
        {
            deltaWeaponAngleByDistance = StaticDatas._ppFunctionByDistanceRight();
        }
        else
        {
            deltaWeaponAngleByDistance = StaticDatas._ppFunctionByDistanceLeft();
        }
