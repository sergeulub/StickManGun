...
public class P90 : PP
{
    public P90(Weapons data) : base(data) { }
    ...
    public override void RotateWeapon()
    {
        ...
        if (isLookingRight)
        {
            deltaWeaponAngleByDistance = StaticDatas._p90FunctionByDistanceRight();
        }
        else
        {
            deltaWeaponAngleByDistance = StaticDatas._p90FunctionByDistanceLeft();
        }
